      ...
      <div className={`${styles.paddingY}`}>
        <div className={`flex flex-col items-center mb-2`}>
          ...
          <p className="font-lato font-normal sm:text-[18px] text-[12px] text-white sm:leading-[30px] leading-[20px] sm:max-w-[816px] max-w-[400px] text-center sm:mb-4 mb-2">
            Built for scalability and security, our battle-tested technology
            allows you to effortlessly scale your learning. Provide learners
            with secure, on-the-go access to your training services anytime,
            anywhere. Enjoy a customizable experience that can be tailored and
            branded to meet unique needs.
          </p>
        </div>
